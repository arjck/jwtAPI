...
return array(
    ...
    'NextApps\\SwaggerUi\\Console\\InstallCommand' => $vendorDir . '/nextapps/laravel-swagger-ui/src/Console/InstallCommand.php',
    'NextApps\\SwaggerUi\\Http\\Controllers\\OpenApiJsonController' => $vendorDir . '/nextapps/laravel-swagger-ui/src/Http/Controllers/OpenApiJsonController.php',
    'NextApps\\SwaggerUi\\Http\\Controllers\\SwaggerOAuth2RedirectController' => $vendorDir . '/nextapps/laravel-swagger-ui/src/Http/Controllers/SwaggerOAuth2RedirectController.php',
    'NextApps\\SwaggerUi\\Http\\Controllers\\SwaggerViewController' => $vendorDir . '/nextapps/laravel-swagger-ui/src/Http/Controllers/SwaggerViewController.php',
    'NextApps\\SwaggerUi\\Http\\Middleware\\EnsureUserIsAuthorized' => $vendorDir . '/nextapps/laravel-swagger-ui/src/Http/Middleware/EnsureUserIsAuthorized.php',
    'NextApps\\SwaggerUi\\SwaggerUiServiceProvider' => $vendorDir . '/nextapps/laravel-swagger-ui/src/SwaggerUiServiceProvider.php',
    ...
    'PHPOpenSourceSaver\\JWTAuth\\Blacklist' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Blacklist.php',
    'PHPOpenSourceSaver\\JWTAuth\\Claims\\Audience' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Claims/Audience.php',
    'PHPOpenSourceSaver\\JWTAuth\\Claims\\Claim' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Claims/Claim.php',
    'PHPOpenSourceSaver\\JWTAuth\\Claims\\Collection' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Claims/Collection.php',
    'PHPOpenSourceSaver\\JWTAuth\\Claims\\Custom' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Claims/Custom.php',
    'PHPOpenSourceSaver\\JWTAuth\\Claims\\DatetimeTrait' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Claims/DatetimeTrait.php',
    'PHPOpenSourceSaver\\JWTAuth\\Claims\\Expiration' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Claims/Expiration.php',
    'PHPOpenSourceSaver\\JWTAuth\\Claims\\Factory' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Claims/Factory.php',
    'PHPOpenSourceSaver\\JWTAuth\\Claims\\IssuedAt' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Claims/IssuedAt.php',
    'PHPOpenSourceSaver\\JWTAuth\\Claims\\Issuer' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Claims/Issuer.php',
    'PHPOpenSourceSaver\\JWTAuth\\Claims\\JwtId' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Claims/JwtId.php',
    'PHPOpenSourceSaver\\JWTAuth\\Claims\\NotBefore' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Claims/NotBefore.php',
    'PHPOpenSourceSaver\\JWTAuth\\Claims\\Subject' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Claims/Subject.php',
    'PHPOpenSourceSaver\\JWTAuth\\Console\\EnvHelperTrait' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Console/EnvHelperTrait.php',
    'PHPOpenSourceSaver\\JWTAuth\\Console\\JWTGenerateCertCommand' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Console/JWTGenerateCertCommand.php',
    'PHPOpenSourceSaver\\JWTAuth\\Console\\JWTGenerateSecretCommand' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Console/JWTGenerateSecretCommand.php',
    'PHPOpenSourceSaver\\JWTAuth\\Contracts\\Claim' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Contracts/Claim.php',
    'PHPOpenSourceSaver\\JWTAuth\\Contracts\\Http\\Parser' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Contracts/Http/Parser.php',
    'PHPOpenSourceSaver\\JWTAuth\\Contracts\\JWTSubject' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Contracts/JWTSubject.php',
    'PHPOpenSourceSaver\\JWTAuth\\Contracts\\Providers\\Auth' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Contracts/Providers/Auth.php',
    'PHPOpenSourceSaver\\JWTAuth\\Contracts\\Providers\\JWT' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Contracts/Providers/JWT.php',
    'PHPOpenSourceSaver\\JWTAuth\\Contracts\\Providers\\Storage' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Contracts/Providers/Storage.php',
    'PHPOpenSourceSaver\\JWTAuth\\Contracts\\Validator' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Contracts/Validator.php',
    'PHPOpenSourceSaver\\JWTAuth\\Exceptions\\InvalidClaimException' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Exceptions/InvalidClaimException.php',
    'PHPOpenSourceSaver\\JWTAuth\\Exceptions\\JWTException' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Exceptions/JWTException.php',
    'PHPOpenSourceSaver\\JWTAuth\\Exceptions\\PayloadException' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Exceptions/PayloadException.php',
    'PHPOpenSourceSaver\\JWTAuth\\Exceptions\\SecretMissingException' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Exceptions/SecretMissingException.php',
    'PHPOpenSourceSaver\\JWTAuth\\Exceptions\\TokenBlacklistedException' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Exceptions/TokenBlacklistedException.php',
    'PHPOpenSourceSaver\\JWTAuth\\Exceptions\\TokenExpiredException' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Exceptions/TokenExpiredException.php',
    'PHPOpenSourceSaver\\JWTAuth\\Exceptions\\TokenInvalidException' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Exceptions/TokenInvalidException.php',
    'PHPOpenSourceSaver\\JWTAuth\\Exceptions\\UserNotDefinedException' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Exceptions/UserNotDefinedException.php',
    'PHPOpenSourceSaver\\JWTAuth\\Facades\\JWTAuth' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Facades/JWTAuth.php',
    'PHPOpenSourceSaver\\JWTAuth\\Facades\\JWTFactory' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Facades/JWTFactory.php',
    'PHPOpenSourceSaver\\JWTAuth\\Facades\\JWTProvider' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Facades/JWTProvider.php',
    'PHPOpenSourceSaver\\JWTAuth\\Factory' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Factory.php',
    'PHPOpenSourceSaver\\JWTAuth\\Http\\Middleware\\Authenticate' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Http/Middleware/Authenticate.php',
    'PHPOpenSourceSaver\\JWTAuth\\Http\\Middleware\\AuthenticateAndRenew' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Http/Middleware/AuthenticateAndRenew.php',
    'PHPOpenSourceSaver\\JWTAuth\\Http\\Middleware\\BaseMiddleware' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Http/Middleware/BaseMiddleware.php',
    'PHPOpenSourceSaver\\JWTAuth\\Http\\Middleware\\Check' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Http/Middleware/Check.php',
    'PHPOpenSourceSaver\\JWTAuth\\Http\\Middleware\\RefreshToken' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Http/Middleware/RefreshToken.php',
    'PHPOpenSourceSaver\\JWTAuth\\Http\\Parser\\AuthHeaders' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Http/Parser/AuthHeaders.php',
    'PHPOpenSourceSaver\\JWTAuth\\Http\\Parser\\Cookies' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Http/Parser/Cookies.php',
    'PHPOpenSourceSaver\\JWTAuth\\Http\\Parser\\InputSource' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Http/Parser/InputSource.php',
    'PHPOpenSourceSaver\\JWTAuth\\Http\\Parser\\KeyTrait' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Http/Parser/KeyTrait.php',
    'PHPOpenSourceSaver\\JWTAuth\\Http\\Parser\\LumenRouteParams' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Http/Parser/LumenRouteParams.php',
    'PHPOpenSourceSaver\\JWTAuth\\Http\\Parser\\Parser' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Http/Parser/Parser.php',
    'PHPOpenSourceSaver\\JWTAuth\\Http\\Parser\\QueryString' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Http/Parser/QueryString.php',
    'PHPOpenSourceSaver\\JWTAuth\\Http\\Parser\\RouteParams' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Http/Parser/RouteParams.php',
    'PHPOpenSourceSaver\\JWTAuth\\JWT' => $vendorDir . '/php-open-source-saver/jwt-auth/src/JWT.php',
    'PHPOpenSourceSaver\\JWTAuth\\JWTAuth' => $vendorDir . '/php-open-source-saver/jwt-auth/src/JWTAuth.php',
    'PHPOpenSourceSaver\\JWTAuth\\JWTGuard' => $vendorDir . '/php-open-source-saver/jwt-auth/src/JWTGuard.php',
    'PHPOpenSourceSaver\\JWTAuth\\Manager' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Manager.php',
    'PHPOpenSourceSaver\\JWTAuth\\Payload' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Payload.php',
    'PHPOpenSourceSaver\\JWTAuth\\Providers\\AbstractServiceProvider' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Providers/AbstractServiceProvider.php',
    'PHPOpenSourceSaver\\JWTAuth\\Providers\\Auth\\Illuminate' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Providers/Auth/Illuminate.php',
    'PHPOpenSourceSaver\\JWTAuth\\Providers\\JWT\\Lcobucci' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Providers/JWT/Lcobucci.php',
    'PHPOpenSourceSaver\\JWTAuth\\Providers\\JWT\\Namshi' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Providers/JWT/Namshi.php',
    'PHPOpenSourceSaver\\JWTAuth\\Providers\\JWT\\Provider' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Providers/JWT/Provider.php',
    'PHPOpenSourceSaver\\JWTAuth\\Providers\\LaravelServiceProvider' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Providers/LaravelServiceProvider.php',
    'PHPOpenSourceSaver\\JWTAuth\\Providers\\LumenServiceProvider' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Providers/LumenServiceProvider.php',
    'PHPOpenSourceSaver\\JWTAuth\\Providers\\Storage\\Illuminate' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Providers/Storage/Illuminate.php',
    'PHPOpenSourceSaver\\JWTAuth\\Support\\CustomClaims' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Support/CustomClaims.php',
    'PHPOpenSourceSaver\\JWTAuth\\Support\\RefreshFlow' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Support/RefreshFlow.php',
    'PHPOpenSourceSaver\\JWTAuth\\Support\\Utils' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Support/Utils.php',
    'PHPOpenSourceSaver\\JWTAuth\\Token' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Token.php',
    'PHPOpenSourceSaver\\JWTAuth\\Validators\\PayloadValidator' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Validators/PayloadValidator.php',
    'PHPOpenSourceSaver\\JWTAuth\\Validators\\TokenValidator' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Validators/TokenValidator.php',
    'PHPOpenSourceSaver\\JWTAuth\\Validators\\Validator' => $vendorDir . '/php-open-source-saver/jwt-auth/src/Validators/Validator.php',
    ...
    'Tests\\Unit\\JwtTest' => $baseDir . '/tests/Unit/JwtTest.php',
